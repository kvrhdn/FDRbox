...
const uint8_t configDescriptor1[]={
	...
	0x01,		//bJackID
	0x00,		//iJack															// TODO index of string descriptor describing jack, can be cool

	/* MIDI Adapter MIDI IN Jack Descriptor (External) */						// TODO can external be removed?
	0x06,		//bLength
	0x24,		//bDescriptorType - CS_INTERFACE
	0x02,		//bDescriptorSubtype - MIDI_IN_JACK
	...
	/* MIDI Adapter Standard Bulk OUT Endpoint Descriptor */					// TODO do we really need bulk?
	0x09,		//bLength
...
const struct{ uint8_t bLength; uint8_t bDscType; uint16_t string[1]; } sd000 = {
	sizeof(sd000),
	USB_DESCRIPTOR_STRING,{0x0409}
};

//Manufacturer string descriptor
const struct{ uint8_t bLength; uint8_t bDscType; uint16_t string[23]; } sd001 = {
	sizeof(sd001),
	USB_DESCRIPTOR_STRING,
	{'K','o','e','n','r','a','a','d',' ','V','e','r','h','e','y','d','e','n',' ','I','n','c','.'}
};
